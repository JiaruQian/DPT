...
def default_compute_score(
    ...
    elif (data_source == "math_dapo" or data_source.startswith("aime") or "APO" in data_source or 
          data_source == "HuggingFaceH4/MATH" or data_source == "minerva_math" or data_source == "olympiad_bench"):
        if extra_info['reward_method'] == 'accuracy_reward':
