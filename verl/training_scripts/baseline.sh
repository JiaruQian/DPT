...
export RAY_runtime_env_setup_timeout_seconds=600

DAPO_train_path=./verl/data_preprocess_scripts/data/dapo/baseline/rl_all_accuracy_reward/train.parquet
APO_combiene_test_path=./verl/data_preprocess_scripts/data/APO_combine/baseline/rl_all_accuracy_reward/test.parquet
train_files="['$DAPO_train_path']"
test_files="['$APO_combiene_test_path']"

project_name=DPT
experiment_name=Baseline
default_local_dir=/data/$project_name/$experiment_name
validation_data_dir=$default_local_dir/val-log
base_model=/data/Qwen3-4B-Base-add-special-token 
